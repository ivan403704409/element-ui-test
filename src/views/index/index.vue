...
<div>
  ...
  <el-row :gutter="20" justify="space-between">
    <!-- 侧边导航 -->
    <el-col class="m-nav" :span="8">
      <el-menu default-active="2" theme="dark" class="el-menu-vertical-demo" >
        <el-submenu index="1">
...
import logMixin from 'src/mixins/log.js'
  export default {
    components:{
      vTable,
      transition,
